...
class DecodingElementTrainer(Node):
    ...
    def __init__(self):
        ...
        super().__init__('data_integrator_subscriber')
        self.subscription_sample = self.create_subscription(
            Sample, '/integrated_data', self.sample_listener_callback, 10
            )
        ...
        self.publisher_ = self.create_publisher(DecoderElement, '/trained_decoding_element', 10)
