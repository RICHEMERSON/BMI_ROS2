...
class SpikeGadgtIrPublisher(Node):
    ...
    def __init__(self):
        ...
        def subscribe_spikes_thread():
           while True:
              RecievedData = spikes.receive() #This will block if no spikes are present
...
def main(args=None):
    ...
    blackrock_passive_ir_publisher = SpikeGadgtIrPublisher()
