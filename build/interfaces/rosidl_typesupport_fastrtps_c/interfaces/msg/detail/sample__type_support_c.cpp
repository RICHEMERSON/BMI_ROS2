...
#include "interfaces/msg/detail/sample__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // x_state, y_observation
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // x_state, y_observation

// forward declare type support functions


using _Sample__ros_msg_type = interfaces__msg__Sample;
...
size_t get_serialized_size_interfaces__msg__Sample(
  const void * untyped_ros_message,
...
static uint32_t _Sample__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Sample(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Sample(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__Sample;
    is_plain =
      (
      offsetof(DataType, y_observation) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Sample__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Sample(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Sample)() {
