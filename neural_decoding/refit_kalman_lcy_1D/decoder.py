...
class RefitKF(object):
    ...
    def fit(self):
        ...
        if len(X)>10:
            ...
            StateModel.coef_[0,0] = 1
            StateModel.coef_[-1,-1] = 1
            StateModel.coef_[1::,0] = 0
            StateModel.coef_[0:-1,-1] = 0
            StateModel.coef_[-1,1] = 0
            
            self._state_matrix = StateModel.coef_.squeeze()
            ...
            self._observation_covariance = (y[:,self._select_neural]-ObservationModel.predict(X)).T@(y[:,self._select_neural]-ObservationModel.predict(X))/len(X)
    ...
    def predict(self,X_test):
        ...
        self._state_covariance[1,1] = next_state_covariance[1,1]

        return self._state_mean.data
